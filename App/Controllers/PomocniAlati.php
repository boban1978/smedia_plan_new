...
$pomocniAlatiClass = new PomocniAlatiClass();
...
switch ($parameter) {
    ...
    case "SporneReklame":
        $response = $pomocniAlatiClass->$parameter();
        break;
    ...
    case "VisakReklame":
        ...
        $page = $_POST['page'];
        $response = $pomocniAlatiClass->$parameter($start,$limit,$sort,$dir,$page);
        break;
...
//        }
        ...
        if($response1->data->capmaignePrice!=$response2->data->capmaignePrice){
