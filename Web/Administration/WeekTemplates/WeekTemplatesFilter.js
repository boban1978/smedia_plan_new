Ext.define('Mediaplan.administration.weekTemplatesAdministration.Filter', {
	extend: 'Ext.form.Panel',
	alias: 'widget.weektemplatesfilter',
        border:false,
        frame:false,
	width:'100%',
	initComponent: function ()
	{
            this.id = 'weekTemplatesAdministrationFilter';
            this.items = [{
                            xtype:'fieldset',
                            title:Lang.Administration_weekTemplatesAdministration_filter_Title,
                            border:true,
                            collapsible: true,
                            labelWidth:150,
                            items:[{
                    		...
                    		items: [{
                                        xtype:'textfield',
                                        fieldLabel:Lang.Administration_weekTemplatesAdministration_filter_Name,
                                        name:'naziv',
                                        width:300
                                },{
										xtype:'combobox',
                                        ...
                                        xtype:'radiogroup',
                                        fieldLabel:Lang.Administration_weekTemplatesAdministration_filter_Active,
                                        labelAlign:'right',
                                        columns: 2,
                                        width:200,
                                        vertical: true,
