Ext.define('Mediaplan.administration.activityTypeAdministration.Filter', {
	extend: 'Ext.form.Panel',
	alias: 'widget.activitytypeadministrationfilter',
        border:false,
        frame:false,
	width:'100%',
        autoRef:'activitytypeadminfilter',
	initComponent: function ()
	{
            this.id = 'activityTypeAdministrationFilter';
            this.items = [{
                            xtype:'fieldset',
                            title:Lang.Administration_activityTypeAdministration_filter_Title,
                            border:true,
                            collapsible: true,
                            labelWidth:150,
                            items:[{
