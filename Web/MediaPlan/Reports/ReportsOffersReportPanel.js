Ext.define('Mediaplan.mediaPlan.reports.offersReport.Panel', {
	extend: 'Ext.form.Panel',
	alias: 'widget.reportofferspanel',
        border:false,
        frame:false,
	width:'100%',
	initComponent: function ()
	{
            this.id = 'reportsOffersReportPanel';
            this.items = [{
                            xtype:'fieldset',
                            title:Lang.MediaPlan_reports_offersReport_Title,
                            border:true,
                            labelWidth:150,
                            padding:'20',
                            items:[{
                    		...
                    		items: [{
                                        xtype: 'combobox',
                                        fieldLabel:Lang.MediaPlan_reports_offersReport_Clients,
                                        name:'klijentID',
                                        ...
                                        xtype: 'combobox',
                                        fieldLabel:Lang.MediaPlan_reports_offersReport_Status,
                                        labelWidth:200,
                                        labelAlign: 'right',
                                        name:'statusID',
                                        store: new Ext.data.Store({
                    		...
                    		items: [{
                                        xtype: 'combobox',
                                        fieldLabel:Lang.MediaPlan_reports_offersReport_ContractType,
                                        name:'tipUgovoraID',
                                        store: new Ext.data.Store({
                                                fields: ['EntryID', 'EntryName'],
                                                proxy: {
                                        ...
                                        xtype: 'combobox',
                                        fieldLabel:Lang.MediaPlan_reports_offersReport_ActivityType,
                                        labelAlign:'right',
                                        labelWidth:200,
                                        name:'delatnostID',
                                        store: new Ext.data.Store({
                    		...
                    		items: [{
                                        xtype:'datefield',
                                        fieldLabel:Lang.MediaPlan_reports_offersReport_DateFrom,
                                        name:'datumOD',
                                        format:'Y-m-d',
                                        width:300
                                },{
                                        ...
                                        labelAlign:'right',
                                        labelWidth:300,
                                        fieldLabel:Lang.MediaPlan_reports_offersReport_DateTo,
                                        name:'datumDO',
                                        format:'Y-m-d',
                                        width:500                                        
                                }]
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function (response, request) {
                            ...
                            if (Common.IsAjaxResponseSuccessfull(response)) {
                                ...
                                Ext.get('reportsOffersIframe').dom.contentWindow.document.body.innerHTML = data[0].html;
                            }
                            else {
                                waitBox.hide();
                                Ext.Msg.show({
